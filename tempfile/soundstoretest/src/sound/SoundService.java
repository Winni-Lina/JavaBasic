...
public class SoundService {
	...
	private void setTestData() {
		this.insertSound(new Sound("sound1", "tester1"));
		this.insertSound(new Sound("sound2", "tester2"));
		this.insertSound(new Sound("sound3", "tester1"));
	}
	...
	public List<Sound> selectAllSoundByAuthor(String author){
		List<Sound> sounds = new ArrayList<Sound>();
		
		for(Sound s : soundList) {
			if(s.getAuthor().equals(author)) sounds.add(s);
		}
